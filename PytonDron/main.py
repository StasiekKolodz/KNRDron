...
# jak nie podamy connection string to sie odpali sitl:
...
# ewentualnie po prostu mozna ustawic na obecną
...
# nwm czy zadziala
def return_home():
    goto(vehicle.home_location, goto_position_target_global_int()) #to trzeba sprawdzić czy wróci tak czy trzeba [0], [1]
